...
#define _DUTY_NEU 1530  // Servo angle: 0 degree
#define _DUTY_MIN 671   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 161 // Replace with |D(352) - E(191)| degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return (1191 - 6.69 * a_value + 1.43E-02 * pow(a_value, 2) - 1.24E-05 * pow(a_value, 3) + 2.83E-09 * pow(a_value, 4));
}
